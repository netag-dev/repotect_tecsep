...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name,job_ref):
...
"            }")
        ...
        self.cbx_customer.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.cbx_customer.setObjectName("cbx_customer")
        self.cbx_customer.addItem("--- Select Custmoer ---")
        ...
        self.cbx_well_number.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.cbx_thread_primary.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.cbx_thread_primary.setPlaceholderText("")
        self.cbx_thread_primary.setObjectName("cbx_thread_primary")
        self.cbx_thread_primary.addItems(["NC26","SLH90","PAC","NC31","NC38","NC40","NC46","NC50","FH","5-1/2 FH","XT-50","XR-39","DSS-55","XT-40","ST-39"])
        ...
        self.txt_id_primary.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.txt_od_primary.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.cbx_size_primary.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.cbx_size_primary.setObjectName("cbx_size_primary")
        self.cbx_size_primary.addItems(["8 5/8","9 5/8","10 3/4","11 3/4","13 3/8"])
        ...
        self.txt_drift_primary.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.txt_description_primary.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.cbx_thread_back_up.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.cbx_thread_back_up.setPlaceholderText("")
        self.cbx_thread_back_up.setObjectName("cbx_thread_back_up")
        self.cbx_thread_back_up.addItems(["NC26","SLH90","PAC","NC31","NC38","NC40","NC46","NC50","FH","5-1/2 FH","XT-50","XR-39","DSS-55","XT-40","ST-39"])
        ...
        self.txt_od_back_up.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.cbx_size_back_up.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.cbx_size_back_up.setObjectName("cbx_size_back_up")
        self.cbx_size_back_up.addItems(["8 5/8","9 5/8","10 3/4","11 3/4","13 3/8"])
        ...
        self.txt_description_back_up.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.txt_id_back_up.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.txt_drift_back_up.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.lbl_casing_size_2.setGeometry(QtCore.QRect(10, 20, 91, 31))
        ...
        self.txt_length.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.cbx_od.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.cbx_od.setPlaceholderText("")
        self.cbx_od.setObjectName("cbx_od")
        self.cbx_od.addItems(["8 5/8","9 5/8","10 3/4","11 3/4","13 3/8"])
        ...
        self.cbx_size.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.cbx_size.setObjectName("cbx_size")
        self.cbx_size.addItems(["8 5/8","9 5/8","10 3/4","11 3/4","13 3/8"])
        ...
        self.txt_size_well.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.txt_weigth_range.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.txt_volume_capacity.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.txt_hole_volume = QtWidgets.QLineEdit(self.tab_well_information)
        self.txt_hole_volume.setGeometry(QtCore.QRect(530, 320, 491, 41))
        ...
        self.cbx_enginer_supervisor.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.cbx_shitf_supervisor.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        ...
        self.lbl_total_days_supervisor = QtWidgets.QLabel(self.tab_wbco_engineer)
        self.lbl_total_days_supervisor.setGeometry(QtCore.QRect(10, 280, 91, 31))
       
        font = QtGui.QFont()
        font.setPointSize(11)
        
        self.lbl_total_days_supervisor.setFont(font)
        self.lbl_total_days_supervisor.setStyleSheet("color: rgb(52, 52, 52);")
        self.lbl_total_days_supervisor.setObjectName("lbl_total_days_supervisor")
        self.txt_total_days_supervisor = QtWidgets.QLineEdit(self.tab_wbco_engineer)
        self.txt_total_days_supervisor.setGeometry(QtCore.QRect(10, 310, 491, 41))
        self.txt_total_days_supervisor.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.txt_total_days_supervisor.setPlaceholderText("")
        self.txt_total_days_supervisor.setObjectName("txt_total_days_supervisor")
        ...
        self.txt_total_days_engineer = QtWidgets.QLineEdit(self.tab_wbco_engineer)
        self.txt_total_days_engineer.setGeometry(QtCore.QRect(560, 310, 491, 41))
        self.txt_total_days_engineer.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.txt_total_days_engineer.setPlaceholderText("")
        self.txt_total_days_engineer.setObjectName("txt_total_days_engineer")
        ...
        self.cdx_shift_techinical.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px\n" "}")
        self.cdx_shift_techinical.setObjectName("cdx_shift_techinical")
        self.cdx_shift_techinical.addItems(["Days","Night"])
        
        self.lbl_total_days_techinical = QtWidgets.QLabel(self.tab_wbco_engineer)
        self.lbl_total_days_techinical.setGeometry(QtCore.QRect(560, 280, 91, 31))
        
        font = QtGui.QFont()
        font.setPointSize(11)
        
        self.lbl_total_days_techinical.setFont(font)
        self.lbl_total_days_techinical.setStyleSheet("color: rgb(52, 52, 52);")
        self.lbl_total_days_techinical.setObjectName("lbl_total_days_techinical")
        ...
        self.lbl_total_days_techinical.raise_()
        ...
        self.lbl_total_days_supervisor.raise_()
        self.txt_total_days_supervisor.raise_()
        self.lbl_techinical.raise_()
        self.cbx_enginer_techinical.raise_()
        self.lbl_shift_techinical.raise_()
        self.txt_total_days_engineer.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_total_days_supervisor.setText(_translate("MainWindow", "Total Days"))
        ...
        self.lbl_total_days_techinical.setText(_translate("MainWindow", "Total Days"))
        ...
        def validatoin_wbco_primary():
            ...
            if has_special_characters(txt_description_primary,only_special_character) or (txt_description_primary == ""):
                ...
                valor_wbco_primary = modulo_wbco.wbcoController.salvar_wbco_primary(txt_description_primary,self.cbx_size_primary.currentText(),cbx_thread_primary,
        ...
        def validatoin_wbco_backup():
            ...
            if has_special_characters(txt_description_back_up,only_special_character) or (txt_description_back_up == ""):
                ...
                id_supervisor = modulo_wbco.wbcoController.carregar_id_supervisor_by_email(self.lbl_user_logado.text())
                id_ultimo_report = modulo_wbco.wbcoController.carregar_buscar_id_report()
                valor_wbco_backup = modulo_wbco.wbcoController.salvar_wbco_backup(txt_description_back_up,self.cbx_size_back_up.currentText(),cbx_thread_back_up,
        ...
        def validatoin_well_information():
            ...
            txt_hole_volume = str(self.txt_hole_volume.text())
            ...
            elif has_special_characters(txt_hole_volume,only_special_character) or (txt_hole_volume == ""):
        ...
        def validatoin_wbco_enginer():
            ...
            txt_total_days_supervisor = str(self.txt_total_days_supervisor.text())
            txt_total_days_engineer = str(self.txt_total_days_engineer.text())
            ...
            if has_special_characters(txt_total_days_supervisor,only_special_character) or (txt_total_days_supervisor == ""):
                message_error_validation("This field does not accept characters or is empty","Total Supervidor days entry error")
           
            elif has_special_characters(txt_total_days_engineer,only_special_character) or (txt_total_days_engineer == ""):
                message_error_validation("This filed does not accept characters empty","Total Techinical days entry error")
            
            elif has_special_characters(cbx_enginer_techinical,caracter_especial) or (cbx_enginer_techinical == ""):
        ...
        def validatoin_activity():
            ...
            if txt_area_on_going == "":
                ...
                modulo_wbco.wbcoController.salvar_report_information(txt_area_on_going,self.cbx_size.currentText(),
                self.txt_length.text(),self.cbx_od.currentText(),self.txt_id.text(),self.txt_size_well.text(),self.txt_weigth_range.text(),self.txt_volume_capacity.text(),
                self.txt_hole_volume.text(),txt_wbco_activity,self.cbx_shitf_supervisor.currentText(),self.txt_total_days_supervisor.text(),id_poco,id_supervisor,id_cliente,id_empregador,id_ultimo_registo_report_header)

                id_empregador_tecnico = modulo_wbco.wbcoController.carregar_buscar_id_empregador_por_nome(cbx_enginer_techinical)
                id_ultimo_report = modulo_wbco.wbcoController.carregar_buscar_id_report()
                valor_retorno = modulo_wbco.wbcoController.salvar_tecnico_em_servico(id_empregador_tecnico,self.cdx_shift_techinical.currentText(),txt_total_days_engineer,id_ultimo_report)
                if valor_retorno == 0:
                    show_message_sucess()
                    self.tab_menus_wbco.setCurrentIndex(4)
                else:
