...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name):
        ...
        self.txt_size.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px;\n font-size:18px;" "}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_salvar_size.clicked.connect(lambda: save_size(self.txt_size.text(),self.txt_description.text()))
        

        

        def save_size(size,description):
           
           retorno = modulo_wbco.sizeController.save_data(size,description)
