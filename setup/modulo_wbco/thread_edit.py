...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name,thread,description ):
        ...
        self.label.setGeometry(QtCore.QRect(40, 50, 400, 31))
        ...
        self.btn_list_thread.setGeometry(QtCore.QRect(920, 240, 191, 31))
        ...
        self.btn_list_thread.setIcon(icon7)
        self.btn_list_thread.setObjectName("btn_list_thread")
        self.txt_thread = QtWidgets.QLineEdit(self.frame)
        self.txt_thread.setGeometry(QtCore.QRect(30, 390, 341, 41))
        self.txt_thread.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px;\n font-size:18px;" "}")
        self.txt_thread.setPlaceholderText("")
        self.txt_thread.setObjectName("txt_thread")
        self.lbl_thread = QtWidgets.QLabel(self.frame)
        self.lbl_thread.setGeometry(QtCore.QRect(30, 360, 81, 31))
        font = QtGui.QFont("Arial")
        font.setPointSize(11)
        self.lbl_thread.setFont(font)
        self.lbl_thread.setStyleSheet("color: rgb(52, 52, 52);")
        self.lbl_thread.setObjectName("lbl_thread")
        ...
        self.btn_salvar_thread = QtWidgets.QPushButton(self.frame)
        self.btn_salvar_thread.setGeometry(QtCore.QRect(750, 390, 341, 41))
        self.btn_salvar_thread.setStyleSheet("\n" "\n" "QPushButton#btn_salvar_thread{\n" "\n" "border:none;\n" "background-color:#044e42;\n" "color:white;\n" "font-size:16px;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "text-align:rigth;\n" "}\n" "\n" "QPushButton#btn_salvar_thread:hover{\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "}\n" "\n" "QPushButton#btn_salvar_thread:pressed {\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "background-color: #033029;\n" "padding:10px;\n" " }\n" "")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("..img/check-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_salvar_thread.setIcon(icon9)
        self.btn_salvar_thread.setIconSize(QtCore.QSize(25, 25))
        self.btn_salvar_thread.setObjectName("btn_salvar_thread")
        
        
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("/img/upload-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        
        self.lbl_thread.raise_()
        ...
        self.line_2.raise_()
        self.line_3.raise_()
        self.btn_list_thread.raise_()
        self.txt_thread.raise_()
        self.txt_description.raise_()
        self.btn_salvar_thread.raise_()
        ...
        self.retranslateUi(MainWindow,thread,description)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow,thread,description):
        ...
        self.label.setText(_translate("MainWindow", "Thread Connections"))
        self.label_2.setText(_translate("MainWindow", "Fill in all the fields to be able to edit a thread Connections to the system"))
        
        self.btn_list_thread.setText(_translate("MainWindow", "List Thread Connections"))
        self.btn_list_thread.clicked.connect(lambda:show_form_list_thread())

        self.lbl_thread.setText(_translate("MainWindow", " Thread Connections"))
        self.lbl_description.setText(_translate("MainWindow", "Description"))

        self.txt_thread.setText(str(thread))
        self.txt_description.setText(str(description))
        
        id_thread = modulo_wbco.threadController.buscar_id_by_description(description,thread)

        self.btn_salvar_thread.setText(_translate("MainWindow", "Save Thread Connections data"))
        self.btn_salvar_thread.clicked.connect(lambda: edit_thread(self.txt_thread.text(),self.txt_description.text(),id_thread))
        

        

        def edit_thread(thread,description,id_thread):
           
           retorno = modulo_wbco.threadController.editar_thread(thread,description,id_thread)
