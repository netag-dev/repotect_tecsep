...
"")    
        ...
        print(list_enginer)
        self.table_employee.setRowCount(15)
        tablerow = 0
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_titulo_form.setText(_translate("MainWindow", "WBCO Tools Personnel"))
        self.lbl_text_form.setText(_translate("MainWindow", "Below is the list of all WBCO Tools Personnel registered in the system"))
       
        self.btn_add_enginer.setText(_translate("MainWindow", "Add WBCO Tools Personnel"))
