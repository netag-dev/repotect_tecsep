...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name):
        ...
        self.lbl_thread.setGeometry(QtCore.QRect(30, 360, 400, 31))
        font = QtGui.QFont("Arial")
        font.setPointSize(11)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_salvar_thread.clicked.connect(lambda: save_thread_connections(self.txt_thread.text(),self.txt_description.text()))
        

        

        def save_thread_connections(thread_connection,description):
           
           retorno = modulo_wbco.threadController.save_data(thread_connection,description)
