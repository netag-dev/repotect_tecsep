...
"")
        ...
        self.btn_add_size = QtWidgets.QPushButton(self.frame)
        self.btn_add_size.setGeometry(QtCore.QRect(920, 240, 191, 31))
        self.btn_add_size.setStyleSheet("\n"
"\n"
"QPushButton#btn_add_size{\n"
"\n"
"border:none;\n"
"background-color:#044e42;\n"
"color:white;\n"
...
"}\n"
"\n"
"QPushButton#btn_add_size:hover{\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"transition: background-color 0.5s ease;\n"
"padding:10px;\n"
"}\n"
"\n"
"QPushButton#btn_add_size:pressed {\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"background-color: #033029;\n"
"padding:10px;\n"
" }\n"
"")
        self.btn_add_size.setIcon(icon7)
        ...
        self.btn_list_wbco_report.setGeometry(QtCore.QRect(720, 240, 191, 31))
...
"")    
        ...
        self.table_size.setObjectName("table_size")
        self.table_size.setColumnCount(5) 
        self.table_size.setHorizontalHeaderLabels(["Size"," ","Description"," "," "])
        ...
        list_size = modulo_wbco.sizeController.listar_size()
        print(list_size)
        self.table_size.setRowCount(30)
        tablerow = 0

        for row in list_size:
            
            self.btn_edit_size = QtWidgets.QPushButton("Edit Size")
            ...
            self.btn_remove_size = QtWidgets.QPushButton("Remove Size")
            ...
            self.table_size.setItem(tablerow,0,QtWidgets.QTableWidgetItem(row[0]))
            self.table_size.setItem(tablerow,1,QtWidgets.QTableWidgetItem(" "))
            self.table_size.setItem(tablerow,2,QtWidgets.QTableWidgetItem(row[1]))
        ...
        def show_form_edit_size(size,description):
            self.window = QtWidgets.QMainWindow()
            import modulo_wbco.size_edit
            self.ui = modulo_wbco.size_edit.Ui_MainWindow()
        ...
        def btn_clicked_edit():
            ...
            if isinstance(self.btn_edit_size, QtWidgets.QPushButton):
                ...
                if (item is not None ) or (item_description is not None):
                    ...
                    show_form_edit_size(size,descritpion)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_titulo_form.setText(_translate("MainWindow", "Size"))
        self.lbl_text_form.setText(_translate("MainWindow", "Below is the list of all Sizes registered in the system"))
       
        self.btn_add_size.setText(_translate("MainWindow", "Add new Size"))
        self.btn_add_size.clicked.connect(lambda: show_form_add_size())
        ...
        def show_form_add_size():
            self.window = QtWidgets.QMainWindow()
            import modulo_wbco.size_add
            self.ui = modulo_wbco.size_add.Ui_MainWindow()
            self.ui.setupUi(self.window,self.lbl_user_logado.text())
            self.window.show()
            MainWindow.close()
