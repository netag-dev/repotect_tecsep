...
class GerarReport:
    def gerar_pdf(self,filename):
        c = canvas.Canvas(filename, pagesize=A4,bottomup=False)  # alternatively use bottomup=False
        width, height = A4

        value_info = modulo_wbco.wbcoController.carregar_info_report_cabecalho()
        value_well_information = modulo_wbco.wbcoController.carregar_well_information()

        value_wbco_primary = modulo_wbco.wbcoController.carregar_wbco_primary(value_well_information[8])
        value_wbco_back_up = modulo_wbco.wbcoController.carregar_wbco_back_up(value_well_information[8])

        value_employe = modulo_wbco.wbcoController.carregar_empregado(value_well_information[8])
        print(value_employe)
        ...
        table_wbco_enginer.drawOn(c,5*mm,50*mm)
