...
class Ui_MainWindow(object):
    def setupUi(self,MainWindow,user_name,name,email,position):
        ...
        self.btn_list_wbco = QtWidgets.QPushButton(self.frame)
        self.btn_list_wbco.setGeometry(QtCore.QRect(920, 240, 191, 31))
        self.btn_list_wbco.setStyleSheet("\n" "\n" "QPushButton#btn_list_wbco{\n" "\n" "border:none;\n" "background-color:#044e42;\n" "color:white;\n" "font-size:12px;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "text-align:rigth;\n" "}\n" "\n" "QPushButton#btn_list_wbco:hover{\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "}\n" "\n" "QPushButton#btn_list_wbco:pressed {\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "background-color: #033029;\n" "padding:10px;\n" " }\n" "")
        self.btn_list_wbco.setIcon(icon7)
        self.btn_list_wbco.setObjectName("btn_list_wbco")
    ...
    def retranslateUi(self, MainWindow,name,email,position):
        ...
        self.lbl_nome_empregado.setText(_translate("MainWindow", " Personnel "))
