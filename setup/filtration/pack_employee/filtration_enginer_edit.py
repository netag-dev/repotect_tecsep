...
class Ui_MainWindow(object):
    def setupUi(self,MainWindow,user_name,name,email,position):
        ...
        self.btn_list_filtration = QtWidgets.QPushButton(self.frame)
        self.btn_list_filtration.setGeometry(QtCore.QRect(920, 240, 191, 31))
        self.btn_list_filtration.setStyleSheet("\n" "\n" "QPushButton#btn_list_filtration{\n" "\n" "border:none;\n" "background-color:#044e42;\n" "color:white;\n" "font-size:12px;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "text-align:rigth;\n" "}\n" "\n" "QPushButton#btn_list_filtration:hover{\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "}\n" "\n" "QPushButton#btn_list_filtration:pressed {\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "background-color: #033029;\n" "padding:10px;\n" " }\n" "")
        self.btn_list_filtration.setIcon(icon7)
        self.btn_list_filtration.setObjectName("btn_list_filtration")
        ...
        self.txt_email.setGeometry(QtCore.QRect(390, 390, 341, 41))
        ...
        self.cbx_personel_position = QtWidgets.QComboBox(self.frame)
        self.cbx_personel_position.setGeometry(QtCore.QRect(750, 390, 341, 41))
        self.cbx_personel_position.setPlaceholderText("")
        self.cbx_personel_position.setObjectName("cbx_personel_position")
        self.cbx_personel_position.addItems(modulo_wbco.wbcoController.lista_personel_position())
        ...
        self.btn_salvar_employee = QtWidgets.QPushButton(self.frame)
        self.btn_salvar_employee.setGeometry(QtCore.QRect(30, 450, 341, 41))
        self.btn_salvar_employee.setStyleSheet("\n" "\n" "QPushButton#btn_salvar_employee{\n" "\n" "border:none;\n" "background-color:#044e42;\n" "color:white;\n" "font-size:15px;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "text-align:rigth;\n" "}\n" "\n" "QPushButton#btn_salvar_employee:hover{\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "}\n" "\n" "QPushButton#btn_salvar_employee:pressed {\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "background-color: #033029;\n" "padding:10px;\n" " }\n" "")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/check-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_salvar_employee.setIcon(icon9)
        self.btn_salvar_employee.setIconSize(QtCore.QSize(25, 25))
        self.btn_salvar_employee.setObjectName("btn_salvar_employee")
        ...
        self.line_2.raise_()
        self.line_3.raise_()
        self.btn_list_filtration.raise_()
        self.txt_nome.raise_()
        self.txt_email.raise_()
        self.btn_salvar_employee.raise_()
        ...
        self.retranslateUi(MainWindow,name,email,position)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow,name,email,position):
        ...
        self.label_2.setText(_translate("MainWindow", "Fill in all the fields to be able to edit Personnel to the system"))
        ...
        self.cbx_personel_position.setCurrentText(str(position))
        self.cbx_personel_position.currentTextChanged.connect(lambda:get_id())
        ...
        def save_engineer(nome,email,personnel_position,id):
           
           retorno = modulo_wbco.enginierwbcoController.editar(nome,email,personnel_position,id)
