...
"")    
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_titulo_form.setText(_translate("MainWindow", "Filtration Personnel"))
        self.lbl_text_form.setText(_translate("MainWindow", "Below is the list of all Filtration Personnel registered in the system"))
       
        self.btn_add_enginer.setText(_translate("MainWindow", "Add Filtration Personnel"))
