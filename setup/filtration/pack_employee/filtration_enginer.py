...
"")    
        ...
        self.table_employee.setHorizontalHeaderLabels(["Employee's name"," E-mail "," Personnel Position"," "," "])
        ...
        list_enginer = filtration.pack_employee.employeeController.listar_table()
        ...
        def show_form_edit_engier(name,email,position):
            ...
            import filtration.pack_employee.filtration_enginer_edit as edit
        ...
        def btn_clicked_delete():
            ...
            if isinstance(self.btn_remove_employee, QtWidgets.QPushButton):
                ...
                if (item is not None ) or (item_email is not None):
                    ...
                    response = filtration.pack_employee.employeeController.eliminar(name,email)
                    if response == 0:
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_customer.clicked.connect(lambda:show_form_list_client())
        ...
        self.label_titulo_form.setText(_translate("MainWindow", "Filtration Employees"))
        self.lbl_text_form.setText(_translate("MainWindow", "Below is the list of allFiltration Employees registered in the system"))
       
        self.btn_add_enginer.setText(_translate("MainWindow", "Add Filtration Employee"))
        ...
        def show_form_add_engineer():
            self.window = QtWidgets.QMainWindow()
            import filtration.pack_employee.filtration_enginer_add
            self.ui = filtration.pack_employee.filtration_enginer_add.Ui_MainWindow()
            self.ui.setupUi(self.window,self.lbl_user_logado.text())
            self.window.show()
            MainWindow.close()
