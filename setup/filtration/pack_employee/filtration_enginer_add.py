...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_list_employee.setText(_translate("MainWindow", "List Filtration Personnel"))
        ...
        def save_engineer(nome,email,personnel_position):
           ...
           retorno = filtration.pack_employee.employeeController.cadastrar(nome, email, get_id_personeel_position())
