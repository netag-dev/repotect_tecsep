...
import filtration.report.filtration_report
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name):
        ...
        self.gerador_report = filtration.report.filtration_report.GerarReport()
...
#---------------------BOtao para listar os Sizes-----------------------------------------
        self.btn_list_type_consumable = QtWidgets.QPushButton(self.frame)
        self.btn_list_type_consumable.setGeometry(QtCore.QRect(720, 240, 191, 33))
        self.btn_list_type_consumable.setStyleSheet("\n"
"\n"
"QPushButton#btn_list_type_consumable{\n"
"\n"
"border:none;\n"
"background-color:#044e42;\n"
"color:white;\n"
...
"}\n"
"\n"
"QPushButton#btn_list_type_consumable:hover{\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"transition: background-color 0.5s ease;\n"
"padding:10px;\n"
"}\n"
"\n"
"QPushButton#btn_list_type_consumable:pressed {\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"background-color: #033029;\n"
"padding:10px;\n"
...
"")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/file-lines-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_list_type_consumable.setIcon(icon9)
        self.btn_list_type_consumable.setObjectName("btn_list_type_consumable")
...
#---------------------BOtao para listar Threads-----------------------------------------
        ...
        self.btn_list_consumable.setGeometry(QtCore.QRect(520, 240, 191, 33))
...
#----------------------------------------------------------------------------------------         
 ...
 #---------------------BOtao para listar Engineer WBCO-----------------------------------------
        self.btn_list_filtration_engineer = QtWidgets.QPushButton(self.frame)
        self.btn_list_filtration_engineer.setGeometry(QtCore.QRect(320, 240, 191, 33))
        self.btn_list_filtration_engineer.setStyleSheet("\n"
"\n"
"QPushButton#btn_list_filtration_engineer{\n"
"\n"
"border:none;\n"
"background-color:#044e42;\n"
"color:white;\n"
...
"}\n"
"\n"
"QPushButton#btn_list_filtration_engineer:hover{\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"transition: background-color 0.5s ease;\n"
"padding:10px;\n"
"}\n"
"\n"
"QPushButton#btn_list_filtration_engineer:pressed {\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"background-color: #033029;\n"
"padding:10px;\n"
...
"")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/file-lines-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_list_filtration_engineer.setIcon(icon_employee)
        self.btn_list_filtration_engineer.setObjectName("btn_list_filtration_engineer")


#----------------------------------------------------------------------------------------              

        self.table_filtration_report = QtWidgets.QTableWidget(self.frame)
        self.table_filtration_report.setGeometry(QtCore.QRect(20, 290, 1091, 421))
        self.table_filtration_report.setAutoFillBackground(True)
        self.table_filtration_report.setStyleSheet("QTableWidget{\n"
"\n"
"\n"
"border:none;\n"
...
"\n"
"")
        self.table_filtration_report.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.table_filtration_report.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.table_filtration_report.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.table_filtration_report.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.table_filtration_report.setTextElideMode(QtCore.Qt.ElideMiddle)
        self.table_filtration_report.setShowGrid(False)
        self.table_filtration_report.setGridStyle(QtCore.Qt.NoPen)
        self.table_filtration_report.setCornerButtonEnabled(False)
        self.table_filtration_report.setObjectName("table_filtration_report")
        self.table_filtration_report.setColumnCount(6)
        self.table_filtration_report.setHorizontalHeaderLabels(["Customer Name","Job. Ref. Number","Rig Name","Date Report","",""])
        self.table_filtration_report.horizontalHeaderItem(0).setTextAlignment(0x0001)
        self.table_filtration_report.horizontalHeaderItem(1).setTextAlignment(0x0001)
        self.table_filtration_report.horizontalHeaderItem(2).setTextAlignment(0x0001)
        self.table_filtration_report.horizontalHeaderItem(3).setTextAlignment(0x0001)
        self.table_filtration_report.horizontalHeaderItem(4).setTextAlignment(0x0001)

        list_report = filtration.pack_report.reportController.listar_report()
        self.table_filtration_report.setRowCount(10)
        tablerow = 0
        ...
        for row in list_report:
            ...
            self.table_filtration_report.setItem(tablerow,0,QtWidgets.QTableWidgetItem(row[0]))
            self.table_filtration_report.setItem(tablerow,1,QtWidgets.QTableWidgetItem(row[1]))
            self.table_filtration_report.setItem(tablerow,2,QtWidgets.QTableWidgetItem(row[2]))
            self.table_filtration_report.setItem(tablerow,3,QtWidgets.QTableWidgetItem(row[3]))
            self.table_filtration_report.setCellWidget(tablerow,4,self.button_download_report)
            self.table_filtration_report.setCellWidget(tablerow,5,self.button_view_report)
        ...
        def buttnon_download_report():
            ...
            if isinstance(self.button_download_report, QtWidgets.QPushButton):
                ...
                index = self.table_filtration_report.indexAt(self.button_download_report.pos())
                row = index.row()
                col = index.column()
                ...
                item = self.table_filtration_report.item(row,col)
                if item is not None:
                    
                    job_ref = item.text()

                    report_cabecalho = filtration.pack_report.reportController.carregar_info_report_cabecalho_por_job_ref(job_ref)
                    cabecalho_prepared = filtration.pack_prepared_aproved.prepared_aprovedController.buscar_nome_prepared(job_ref)
                    cabecalho_aproved = filtration.pack_prepared_aproved.prepared_aprovedController.buscar_nome_aproved(job_ref)
                    fluid_information = filtration.pack_fluid_information.fluid_informationController.listar_fluid_por_job_ref(job_ref)
                    primeiro_ciclo = filtration.pack_filtration_sumary.fluid_sumaryController.buscar_report_primeiro_ciclo(job_ref)
                    seg_ciclo = filtration.pack_filtration_sumary.fluid_sumaryController.buscar_report_segundo_ciclo(job_ref)
                    terc_ciclo = filtration.pack_filtration_sumary.fluid_sumaryController.buscar_report_terceiro_ciclo(job_ref)
                    quart_ciclo = filtration.pack_filtration_sumary.fluid_sumaryController.buscar_report_quarto_ciclo(job_ref)
                    quint_ciclo = filtration.pack_filtration_sumary.fluid_sumaryController.buscar_report_quinto_ciclo(job_ref)
                    sext_ciclo = filtration.pack_filtration_sumary.fluid_sumaryController.buscar_report_sexto_ciclo(job_ref)
                    set_ciclo = filtration.pack_filtration_sumary.fluid_sumaryController.buscar_report_setimo_ciclo(job_ref)
                    oit_ciclo = filtration.pack_filtration_sumary.fluid_sumaryController.buscar_report_oitavo_ciclo(job_ref)
                    fluid_analysis = filtration.pack_fluid_analisys.fluid_analisysController.listar_por_job_ref(job_ref)
                    ongoing = filtration.pack_report.reportController.buscar_ongoing_activity(job_ref)
                    consumiveis = filtration.pack_fluid_consumables.fluid_consumablesController.carregar_listagem(job_ref)
                    enginheiro = filtration.pack_enginer_day.enginer_dayController.listar(job_ref)
                    ...
                    filemane = "Daily "+str(report_cabecalho[0])+"Report_Filtration.pdf"
                    self.gerador_report.gerar_pdf(filemane,report_cabecalho,cabecalho_prepared,cabecalho_aproved,fluid_information,primeiro_ciclo,seg_ciclo,terc_ciclo,quart_ciclo,quint_ciclo,sext_ciclo,set_ciclo,oit_ciclo,fluid_analysis,ongoing,consumiveis,enginheiro)
                    show_message_sucess()
        ...
        def view_report():
            ...
            if isinstance(self.button_view_report, QtWidgets.QPushButton):
                ...
                index = self.table_filtration_report.indexAt(self.button_view_report.pos())
                row = index.row()
                col = index.column()
                ...
                if item is not None:
                    ...
                    filemane = "Daily_Report_"+str(report_cabecalho[0])+"Report_Filtration.pdf"
        ...
        self.table_filtration_report.horizontalHeader().setDefaultSectionSize(217)
        self.table_filtration_report.horizontalHeader().setHighlightSections(False)
        self.table_filtration_report.verticalHeader().setVisible(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_titulo_form.setText(_translate("MainWindow", "Filtration"))
        self.lbl_text_form.setText(_translate("MainWindow", "Below are all the reports generated in the system regarding the Filtration"))
        ...
        self.btn_list_filtration_engineer.setText(_translate("MainWindow"," Filtration Personnel"))
        self.btn_list_filtration_engineer.clicked.connect(lambda:show_form_list_enginer())

        self.table_filtration_report.setSortingEnabled(False)
        ...
        def show_form_list_type_consumable():
            self.window = QtWidgets.QMainWindow()
            import filtration.pack_fluid_consumables_type.type_consumable
            self.ui = filtration.pack_fluid_consumables_type.type_consumable.Ui_MainWindow()
        ...
        def show_form_list_consumable():
            self.window = QtWidgets.QMainWindow()
            import filtration.pack_consumiveis.consumables
            self.ui = filtration.pack_consumiveis.consumables.Ui_MainWindow()
            self.ui.setupUi(self.window,self.lbl_user_logado.text())
            self.window.show()
            MainWindow.close()
        ...
        def show_form_list_enginer():
            self.window = QtWidgets.QMainWindow()
            import filtration.pack_employee.filtration_enginer
            self.ui = filtration.pack_employee.filtration_enginer.Ui_MainWindow()
            self.ui.setupUi(self.window,self.lbl_user_logado.text())
            self.window.show()
            MainWindow.close()
        ...
        def show_form_add_filtration_report():
            self.window = QtWidgets.QMainWindow()
            import filtration.filtration_report_add
            self.ui = filtration.filtration_report_add.Ui_MainWindow()
            self.ui.setupUi(self.window,self.lbl_user_logado.text())
            self.window.show()
            MainWindow.close()
