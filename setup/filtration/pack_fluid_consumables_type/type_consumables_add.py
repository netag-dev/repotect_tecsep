...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name):
        ...
        self.btn_list_type_consumible = QtWidgets.QPushButton(self.frame)
        self.btn_list_type_consumible.setGeometry(QtCore.QRect(920, 240, 191, 31))
        self.btn_list_type_consumible.setStyleSheet("\n" "\n" "QPushButton#btn_list_type_consumible{\n" "\n" "border:none;\n" "background-color:#044e42;\n" "color:white;\n" "font-size:12px;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "text-align:rigth;\n" "}\n" "\n" "QPushButton#btn_list_type_consumible:hover{\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "}\n" "\n" "QPushButton#btn_list_type_consumible:pressed {\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "background-color: #033029;\n" "padding:10px;\n" " }\n" "")
        self.btn_list_type_consumible.setIcon(icon7)
        ...
        self.btn_salvar_type_consumable.setIconSize(QtCore.QSize(25, 25))
        self.btn_salvar_type_consumable.setObjectName("btn_salvar_type_consumable")
    ...
    def retranslateUi(self, MainWindow):
        ...
        def save_consumable(type,desc):
           
           retorno = controller.cadastrar(type,desc)
           if retorno == 0:
