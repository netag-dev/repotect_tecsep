...
import filtration.pack_consumiveis.consumiveisController as controller


class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name,id,nome,stoq):
        ...
        self.retranslateUi(MainWindow,id,nome,stoq)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow,id,nome,stoq):
        ...
        self.lbl_stoq.setText(_translate("MainWindow", "Stock Quantity"))
        ...
        self.btn_salvar_consumiveis.clicked.connect(lambda: save_consumable())
        
        

        def save_consumable():
           
           retorno = controller.editar(self.txt_nome_consumivel.text(),self.txt_quantidade_stoke.text(),id)
