...
"")
        ...
        self.btn_add_mud_type = QtWidgets.QPushButton(self.frame)
        self.btn_add_mud_type.setGeometry(QtCore.QRect(830, 240, 280, 31))
        self.btn_add_mud_type.setStyleSheet("\n"
"\n"
"QPushButton#btn_add_mud_type{\n"
"\n"
"border:none;\n"
"background-color:#044e42;\n"
"color:white;\n"
...
"}\n"
"\n"
"QPushButton#btn_add_mud_type:hover{\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"transition: background-color 0.5s ease;\n"
"padding:2px;\n"
"}\n"
"\n"
"QPushButton#btn_add_mud_type:pressed {\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"background-color: #033029;\n"
"padding:2px;\n"
...
"")
        ...
        self.btn_add_mud_type.setIcon(icon7)
        self.btn_add_mud_type.setObjectName("btn_add_mud_type")
...
"")    
        ...
        def show_form_edit_size(description,id):
            ...
            import compliance.pack_mud_type.edit_mud_type as edit
        ...
        def show_form_list_size():
            self.window = QtWidgets.QMainWindow()
            import compliance.pack_mud_type.mud_type as view
        ...
        def btn_clicked_edit():
            ...
            if isinstance(self.btn_edit_size, QtWidgets.QPushButton):
                ...
                if (item_id is not None ) or (item_description is not None):
    ...
    def retranslateUi(self, MainWindow):
        ...
        def show_form_add_mud_type():
            self.window = QtWidgets.QMainWindow()
            import compliance.pack_mud_type.add_mud_type as add_model
