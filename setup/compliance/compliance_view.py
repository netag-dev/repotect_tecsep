...
from compliance.pack_compliance_enginer import enginierController as controller_enginer
...
"")
        ...
        def buttnon_download_report():
            ...
            if isinstance(self.button_download_report, QtWidgets.QPushButton):
                ...
                if item is not None:
                    ...
                    enginer = controller_enginer.buscar_enginer_by_job_ref(job_ref)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_list_compliance_engineer.setText(_translate("MainWindow"," Compliance Personnel"))
