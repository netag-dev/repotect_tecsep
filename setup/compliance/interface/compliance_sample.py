...
"}")
        ...
        self.txt_wgceg_2 = QtWidgets.QLineEdit(self.frame)
        self.txt_wgceg_2.setGeometry(QtCore.QRect(720, 210, 301, 41))
        self.txt_wgceg_2.setStyleSheet("QLineEdit{\n"
"\n"
"\n"
"background-color:#fff;\n"
"border: 1px solid #8ec0af;\n"
"border-radius: 6px\n"
"}")
        self.txt_wgceg_2.setPlaceholderText("")
        self.txt_wgceg_2.setObjectName("txt_wgceg_2")
