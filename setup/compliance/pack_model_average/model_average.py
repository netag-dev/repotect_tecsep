...
"height:30px;")
        ...
        self.label_titulo_form.setGeometry(QtCore.QRect(40, 50, 551, 45))
...
"")
        ...
        self.btn_add_model_averange = QtWidgets.QPushButton(self.frame)
        self.btn_add_model_averange.setGeometry(QtCore.QRect(830, 240, 280, 31))
        self.btn_add_model_averange.setStyleSheet("\n"
"\n"
"QPushButton#btn_add_model_averange{\n"
"\n"
"border:none;\n"
"background-color:#044e42;\n"
"color:white;\n"
...
"}\n"
"\n"
"QPushButton#btn_add_model_averange:hover{\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"transition: background-color 0.5s ease;\n"
"padding:2px;\n"
"}\n"
"\n"
"QPushButton#btn_add_model_averange:pressed {\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"background-color: #033029;\n"
"padding:2px;\n"
...
"")
        ...
        self.btn_add_model_averange.setIcon(icon7)
        self.btn_add_model_averange.setObjectName("btn_add_model_averange")
...
"")    
        ...
        self.table_size.setHorizontalHeaderLabels(["Ref","Model","S/N"," "," "])
        ...
        def show_form_edit(model,serial_number,id):
            self.window = QtWidgets.QMainWindow()
            import compliance.pack_model_average.edit_average_model as edit
            self.ui = edit.Ui_MainWindow()
            self.ui.setupUi(self.window,model,serial_number,id,self.lbl_user_logado.text())
            self.window.show()
            MainWindow.close()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_titulo_form.setText(_translate("MainWindow", "Model Drying Equipment"))
        self.lbl_text_form.setText(_translate("MainWindow", "Below is the list of all Model Drying Equipment registered in the system"))
       
        self.btn_add_model_averange.setText(_translate("MainWindow", "Add new Model Drying Equipment"))
        self.btn_add_model_averange.clicked.connect(lambda: show_form_add_model_average())
        ...
        def show_form_add_model_average():
            self.window = QtWidgets.QMainWindow()
            import compliance.pack_model_average.add_average_model as add_model
