...
from compliance.pack_sample_location import sample_locationController as controller
...
"height:30px;")
        ...
        self.label_titulo_form.setGeometry(QtCore.QRect(40, 50, 451, 31))
...
"border-color: rgb(255, 255, 255);")
        ...
        self.lbl_text_form.setGeometry(QtCore.QRect(40, 90, 631, 16))
...
"")
        ...
        self.btn_add_sample_location = QtWidgets.QPushButton(self.frame)
        self.btn_add_sample_location.setGeometry(QtCore.QRect(830, 240, 280, 31))
        self.btn_add_sample_location.setStyleSheet("\n"
"\n"
"QPushButton#btn_add_sample_location{\n"
"\n"
"border:none;\n"
"background-color:#044e42;\n"
"color:white;\n"
...
"}\n"
"\n"
"QPushButton#btn_add_sample_location:hover{\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"transition: background-color 0.5s ease;\n"
"padding:2px;\n"
"}\n"
"\n"
"QPushButton#btn_add_sample_location:pressed {\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"background-color: #033029;\n"
"padding:2px;\n"
...
"")
        ...
        self.btn_add_sample_location.setIcon(icon7)
        self.btn_add_sample_location.setObjectName("btn_add_sample_location")
...
"")    
        ...
        self.table_size.setHorizontalHeaderLabels(["Ref","Description",""," "," "])
        ...
        for row in list:
            ...
            self.table_size.setItem(tablerow,2,QtWidgets.QTableWidgetItem(""))
        ...
        def show_form_edit_size(description,id):
            self.window = QtWidgets.QMainWindow()
            import compliance.pack_sample_location.edit_sample_location as edit
            self.ui = edit.Ui_MainWindow()
            self.ui.setupUi(self.window,description,id,self.lbl_user_logado.text())
            self.window.show()
        ...
        def btn_clicked_edit():
            ...
            if isinstance(self.btn_edit_size, QtWidgets.QPushButton):
                ...
                if (item is not None ) or (item_description is not None):
                    ...
                    show_form_edit_size(descritpion,id)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_titulo_form.setText(_translate("MainWindow", "Sample Location"))
        self.lbl_text_form.setText(_translate("MainWindow", "Below is the list of all sample location registered in the system"))
       
        self.btn_add_sample_location.setText(_translate("MainWindow", "Add new sample location"))
        self.btn_add_sample_location.clicked.connect(lambda: show_form_add_sample_location())
        ...
        def show_form_add_sample_location():
            self.window = QtWidgets.QMainWindow()
            import compliance.pack_sample_location.add_sample_location as add_model
