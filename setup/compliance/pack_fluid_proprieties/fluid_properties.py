...
import compliance.pack_fluid_proprieties.fluiid_properties_Controller as Controller
...
"height:30px;")
        ...
        self.label_titulo_form.setGeometry(QtCore.QRect(40, 50, 451, 41))
...
"border-color: rgb(255, 255, 255);")
        ...
        self.lbl_text_form.setGeometry(QtCore.QRect(40, 90, 731, 20))
...
"")
        ...
        self.btn_add_fluid_propertes = QtWidgets.QPushButton(self.frame)
        self.btn_add_fluid_propertes.setGeometry(QtCore.QRect(830, 240, 280, 31))
        self.btn_add_fluid_propertes.setStyleSheet("\n"
"\n"
"QPushButton#btn_add_fluid_propertes{\n"
"\n"
"border:none;\n"
"background-color:#044e42;\n"
"color:white;\n"
...
"}\n"
"\n"
"QPushButton#btn_add_fluid_propertes:hover{\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"transition: background-color 0.5s ease;\n"
"padding:2px;\n"
"}\n"
"\n"
"QPushButton#btn_add_fluid_propertes:pressed {\n"
" background-color: #044e42;\n"
"border-radius: 6px;\n"
"background-color: #033029;\n"
"padding:2px;\n"
...
"")
        ...
        self.btn_add_fluid_propertes.setIcon(icon7)
        self.btn_add_fluid_propertes.setObjectName("btn_add_fluid_propertes")
...
"")    
        ...
        def show_form_edit_size(id,description):
        ...
        def btn_clicked_edit():
            ...
            if isinstance(self.btn_edit_size, QtWidgets.QPushButton):
                ...
                id_item = self.table_size.item(row,col)
                
                item_descricao = self.table_size.item(row,col_aux)
                
                if (item_descricao is not None ) or (id_item is not None):
                    
                    descricao = item_descricao.text()
                    id = id_item.text()

                    show_form_edit_size(id,descricao)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_titulo_form.setText(_translate("MainWindow", "Drilling Fluid properties"))
        self.lbl_text_form.setText(_translate("MainWindow", "Below is the list of all Drilling Fluid properties registered in the system"))
       
        self.btn_add_fluid_propertes.setText(_translate("MainWindow", "Add new Fluid Proprties"))
        self.btn_add_fluid_propertes.clicked.connect(lambda: show_form_add_fluid_properties())
        ...
        def show_form_add_fluid_properties():
            self.window = QtWidgets.QMainWindow()
