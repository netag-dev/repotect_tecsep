...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "PPEs"))
        self.label_2.setText(_translate("MainWindow", "Fill in all the fields to be able to add a new PPE to the system"))
        
        self.btn_list_consumivel.setText(_translate("MainWindow", "List PPEs"))
        ...
        self.btn_salvar_consumiveis.clicked.connect(lambda: save_ppe(self.txt_nome_consumivel.text(),self.txt_quantidade_stoke.text()))
    

        def save_ppe(nome,stoq):
           
           retorno = tank_cleanning.pack_pipe.pipeController.cadastrar(nome,stoq)
