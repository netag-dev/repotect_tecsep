...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name,id,stoq,nome):
        ...
        self.txt_nome_ppe = QtWidgets.QLineEdit(self.frame)
        self.txt_nome_ppe.setGeometry(QtCore.QRect(30, 390, 341, 41))
        self.txt_nome_ppe.setStyleSheet("""
            QLineEdit {
        ...
        """)
        self.txt_nome_ppe.setPlaceholderText("")
        self.txt_nome_ppe.setObjectName("txt_nome_ppe")
        ...
        self.btn_salvar_ppe = QtWidgets.QPushButton(self.frame)
        self.btn_salvar_ppe.setGeometry(QtCore.QRect(750, 390, 341, 41))
        self.btn_salvar_ppe.setStyleSheet("\n" "\n" "QPushButton#btn_salvar_ppe{\n" "\n" "border:none;\n" "background-color:#044e42;\n" "color:white;\n" "font-size:15px;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "text-align:rigth;\n" "}\n" "\n" "QPushButton#btn_salvar_ppe:hover{\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "}\n" "\n" "QPushButton#btn_salvar_ppe:pressed {\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "background-color: #033029;\n" "padding:10px;\n" " }\n" "")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/check-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_salvar_ppe.setIcon(icon9)
        self.btn_salvar_ppe.setIconSize(QtCore.QSize(25, 25))
        self.btn_salvar_ppe.setObjectName("btn_salvar_ppe")
        ...
        self.txt_nome_ppe.raise_()
        self.txt_quantidade_stoke.raise_()
        self.btn_salvar_ppe.raise_()
    ...
    def retranslateUi(self, MainWindow,id,stoq,nome):
        ...
        self.label_2.setText(_translate("MainWindow", "Fill in all the fields to be able to edit a PPEs to the system"))
