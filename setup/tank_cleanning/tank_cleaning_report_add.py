...
"border-radius: 6px")
        ...
        self.lbl_equipament_material.setGeometry(QtCore.QRect(10, 310, 241, 31))
        font = QtGui.QFont("Arial")
        font.setPointSize(11)
...
"")
    ...
    def retranslateUi(self, MainWindow,user_logado):
        ...
        self.lbl_equipament_material.setText(_translate("MainWindow", "Equipment Slash Material"))
