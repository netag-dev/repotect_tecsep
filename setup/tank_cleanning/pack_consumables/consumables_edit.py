...
import tank_cleanning.pack_consumables.consumablesController as controller
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_nome_empregado.setText(_translate("MainWindow", " Description Consumable "))
        ...
        id_consumiveis = controller.buscar_id_nome_stoq(self.txt_nome_consumivel.text(),self.txt_quantidade_stoke.text())

        self.btn_salvar_consumiveis.clicked.connect(lambda: save_consumable(self.txt_nome_consumivel.text(),self.txt_quantidade_stoke.text(),id_consumiveis))
        
        
        

        def save_consumable(nome,stoq,id_consumiveis):
           
           retorno = controller.editar(nome,stoq,id_consumiveis)
