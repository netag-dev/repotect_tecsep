...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name):
        ...
        self.txt_nome_consumivel = QtWidgets.QLineEdit(self.frame)
        self.txt_nome_consumivel.setGeometry(QtCore.QRect(30, 390, 341, 41))
        self.txt_nome_consumivel.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px;\n font-size:18px;" "}")
        self.txt_nome_consumivel.setPlaceholderText("")
        self.txt_nome_consumivel.setObjectName("txt_nome_consumivel")
        ...
        self.txt_quantidade_stoke.setValidator(QIntValidator()) 

        

        self.lbl_email = QtWidgets.QLabel(self.frame)
        self.lbl_email.setGeometry(QtCore.QRect(390, 360, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.txt_nome_consumivel.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Fill in all the fields to be able to add a new Asset to the system"))
        
        self.btn_list_consumivel.setText(_translate("MainWindow", "List Assets"))
        ...
        self.lbl_email.setText(_translate("MainWindow", "Stocke Quantity"))
        
        self.btn_salvar_consumiveis.setText(_translate("MainWindow", "Save Asset data"))

        
        self.btn_salvar_consumiveis.clicked.connect(lambda: save_consumable(self.txt_nome_consumivel.text(),self.txt_quantidade_stoke.text()))
        
        

        def save_consumable(nome,stoq):
            retorno = tank_cleanning.pack_assets.assetsController.cadastrar(nome,stoq)
            if (nome != ""):
                if(stoq != ""):
                    if retorno == 0:
                    ...
                    show_message_error("Error when inserting Error whe","Quantity field empty")
            else:
                show_message_error("Error when inserting","Name field empty")
        ...
        def show_form_list_asset():
            ...
            import  tank_cleanning.pack_assets.asets
            self.ui = tank_cleanning.pack_assets.asets.Ui_MainWindow()
