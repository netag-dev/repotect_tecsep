...
import tank_cleanning.pack_assets.assetsController as controller
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name,nome,stoq):
        ...
        self.label.setGeometry(QtCore.QRect(40, 50, 400, 35))
        ...
        self.btn_list_consumivel = QtWidgets.QPushButton(self.frame)
        self.btn_list_consumivel.setGeometry(QtCore.QRect(920, 240, 191, 31))
        self.btn_list_consumivel.setStyleSheet("\n" "\n" "QPushButton#btn_list_consumivel{\n" "\n" "border:none;\n" "background-color:#044e42;\n" "color:white;\n" "font-size:12px;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "text-align:rigth;\n" "}\n" "\n" "QPushButton#btn_list_consumivel:hover{\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "}\n" "\n" "QPushButton#btn_list_consumivel:pressed {\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "background-color: #033029;\n" "padding:10px;\n" " }\n" "")
        self.btn_list_consumivel.setIcon(icon7)
        self.btn_list_consumivel.setObjectName("btn_list_consumivel")

        self.txt_nome_asset = QtWidgets.QLineEdit(self.frame)
        self.txt_nome_asset.setGeometry(QtCore.QRect(30, 390, 341, 41))
        self.txt_nome_asset.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px;\n font-size:18px;" "}")
        self.txt_nome_asset.setPlaceholderText("")
        self.txt_nome_asset.setObjectName("txt_nome_asset")
        self.txt_nome_asset.setText(str(nome))

        self.lbl_nome_empregado = QtWidgets.QLabel(self.frame)
        self.lbl_nome_empregado.setGeometry(QtCore.QRect(30, 360, 400, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.lbl_nome_empregado.setFont(font)
        self.lbl_nome_empregado.setStyleSheet("color: rgb(52, 52, 52);")
        self.lbl_nome_empregado.setObjectName("lbl_nome_empregado")

        self.txt_quantidade_stoke = QtWidgets.QLineEdit(self.frame)
        self.txt_quantidade_stoke.setGeometry(QtCore.QRect(390, 390, 341, 41))
        self.txt_quantidade_stoke.setStyleSheet("QLineEdit{\n" "\n" "\n" "background-color:#fff;\n" "border: 1px solid #8ec0af;\n" "border-radius: 6px;\n font-size:18px;" "}")
        self.txt_quantidade_stoke.setPlaceholderText("")
        self.txt_quantidade_stoke.setObjectName("txt_quantidade_stoke")
        self.txt_quantidade_stoke.setText(str(stoq))


        

        self.lbl_stoq = QtWidgets.QLabel(self.frame)
        self.lbl_stoq.setGeometry(QtCore.QRect(390, 360, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.lbl_stoq.setFont(font)
        self.lbl_stoq.setStyleSheet("color: rgb(52, 52, 52);")
        self.lbl_stoq.setObjectName("lbl_stoq")
        ...
        self.btn_salvar_consumiveis = QtWidgets.QPushButton(self.frame)
        self.btn_salvar_consumiveis.setGeometry(QtCore.QRect(750, 390, 341, 41))
        self.btn_salvar_consumiveis.setStyleSheet("\n" "\n" "QPushButton#btn_salvar_consumiveis{\n" "\n" "border:none;\n" "background-color:#044e42;\n" "color:white;\n" "font-size:15px;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "text-align:rigth;\n" "}\n" "\n" "QPushButton#btn_salvar_consumiveis:hover{\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "transition: background-color 0.5s ease;\n" "padding:10px;\n" "}\n" "\n" "QPushButton#btn_salvar_consumiveis:pressed {\n" " background-color: #044e42;\n" "border-radius: 6px;\n" "background-color: #033029;\n" "padding:10px;\n" " }\n" "")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/check-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_salvar_consumiveis.setIcon(icon9)
        self.btn_salvar_consumiveis.setIconSize(QtCore.QSize(25, 25))
        self.btn_salvar_consumiveis.setObjectName("btn_salvar_consumiveis")
        
        
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("/img/upload-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        
        self.lbl_nome_empregado.raise_()
        self.lbl_stoq.raise_()
        self.frame_2.raise_()
        self.frame_3.raise_()
        self.frame_9.raise_()
        self.line_2.raise_()
        self.line_3.raise_()
        self.btn_list_consumivel.raise_()
        self.txt_nome_asset.raise_()
        self.txt_quantidade_stoke.raise_()
        self.btn_salvar_consumiveis.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Assents"))
        self.label_2.setText(_translate("MainWindow", "Fill in all the fields to be able to edit a Assent to the system"))
        
        self.btn_list_consumivel.setText(_translate("MainWindow", "List Assents"))
        self.btn_list_consumivel.clicked.connect(lambda:show_form_list_asset())

        self.lbl_nome_empregado.setText(_translate("MainWindow", " Asset Name "))
        self.lbl_stoq.setText(_translate("MainWindow", "Stocke Quantity"))

        self.btn_salvar_consumiveis.setText(_translate("MainWindow", "Save Asset data"))


        id_asset = controller.buscar_id_nome_stoq(self.txt_nome_asset.text(),self.txt_quantidade_stoke.text())
        
        self.btn_salvar_consumiveis.clicked.connect(lambda: save_consumable(self.txt_nome_asset.text(),self.txt_quantidade_stoke.text(),id_asset))
        
        

        def save_consumable(nome,stoq,id_asset):
           
           retorno = controller.editar(nome,stoq,id_asset)
           ...
           if retorno == 0:
              ...
              show_message_error("Error when updating","Error when saving data")
        ...
        def show_form_list_asset():
            ...
            import tank_cleanning.pack_assets.asets as controller
            self.ui = controller.Ui_MainWindow()
