...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow,name,email,position):
        ...
        self.btn_list_filtration.setText(_translate("MainWindow", "List Tank Cleaning Employees"))
        ...
        def save_engineer(nome,email,id):
           
           retorno = tank_cleanning.pack_employee.employeeController.editar(nome,email,id)
