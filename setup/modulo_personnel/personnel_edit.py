...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,user_name,id_card):
        ...
        self.retranslateUi(MainWindow,id_card)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow,id_card):
        ...
        self.label_2.setText(_translate("MainWindow", "Fill in all the fields to be able to edit a person to the system"))
        ...
        def validation_add_user():
            ...
            if user_name == "" or identfy_card == "" or phone_number == "" or email == "" or password == "":
                ...
                msg_validation.setText('Unsuccessful Editing, existence of empty fields')
                msg_validation.setWindowTitle(' Error Editing User')
                msg_validation.exec_()
            else:
                estado_editar = modulo_personnel.personnelController.carregar_pessoa_editar( id_pessoa,identfy_card,user_name, email, password, phone_number, self.cb_tipo_usuario.currentText())
                if(estado_editar == 0):
                    show_message_sucess()
                    ...
                    msg_validation = QMessageBox()
                    msg_validation.setIcon(QMessageBox.Critical)
                    msg_validation.setText('Error Editing User')
                    msg_validation.setWindowTitle(' Error Editing User')
                    msg_validation.exec_()
